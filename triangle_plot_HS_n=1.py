...
arquivo = "/home/usuario/Documentos/Códigos/Estudo_do_contraste/MCMC/Resultados_HS2_n1_new.txt"  # Substitua pelo nome do seu arquivo
...
plt.savefig("MCMC_HS_n1_new.pdf", dpi=520, format='pdf', bbox_inches='tight')
plt.show()
