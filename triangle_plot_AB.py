...
arquivo = "/home/usuario/Documentos/Códigos/Estudo_do_contraste/MCMC/Results_SNe+CC+RSD_AB.txt"  # Substitua pelo nome do seu arquivo
nomes_dos_parametros = [r"$H_0$", r"$\Omega_{m,0}$", r"$\sigma_{8,0}$", r"$M_B$", r"b"]  # Nomeie os parâmetros conforme necessário
...
plt.savefig("bruno_AB.pdf", dpi=520, format='pdf', bbox_inches='tight')
plt.show()
