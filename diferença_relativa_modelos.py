...
# -*- coding: utf-8 -*-
"""
Created on Tue May 28 10:31:18 2024
...
diff1 = ( sol_DAB(70, 0.3, 1.6) - D_RG ) / D_RG
...
#plt.xlabel('z')
#plt.ylabel('$\delta(z)$')
#plt.savefig('dif_rel_AB_LCDM.png', dpi=520, format='png', bbox_inches='tight')
#plt.show()
...
#plt.xlabel('z')
#plt.ylabel('$\delta(z)$')
#plt.savefig('dif_rel_wCDM_LCDM.png', dpi=520, format='png', bbox_inches='tight')
#plt.show()
...
diff3 = ( D_RG_k - D_RG ) / D_RG

plt.plot(z, diff3, color='green', linewidth = 2, label='($\Omega_k$-CDM - $\Lambda$CDM) / $\Lambda$CDM')
plt.legend()
plt.ylim(-0.0002,0.0002)
plt.xlabel('z')
#plt.savefig('dif_rel_OkCDM_LCDM.png', dpi=520, format='png', bbox_inches='tight')
plt.show()
...
diff4 = (solD_S(70,0.3,1,1) - D_RG) / D_RG

diff5 = (solD_S(70,0.3,1,2) - D_RG) / D_RG


#plt.plot(z, diff5, color='darkgoldenrod', linewidth = 2, label='(Starobinski (n=2) - $\Lambda$CDM) / $\Lambda$CDM')
#plt.legend()
#plt.xlabel('z')
#plt.savefig('dif_rel_S(n=2)_LCDM.png', dpi=520, format='png', bbox_inches='tight')
#plt.show()
