...
# -*- coding: utf-8 -*-
"""
Created on Fri May 17 13:12:48 2024
...
def Densidade(t, y):    # t é o fator de escala e y é o delta (contraste)
    ...
    dH_RG = - (H_RG/t) - 0.5*(H0/t)*(H0/H_RG)*(O_m - 2*O_L)        # derivada do H(z), vem da 2 eq de Friedmann
...
#plt.plot(z, G, color='deeppink', linewidth = 2, label='$\Lambda$CDM')
#plt.xlabel('z')
#plt.ylabel('G(a)')
#plt.legend()
#plt.show()
