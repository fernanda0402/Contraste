# -*- coding: utf-8 -*-
"""triangle_plot_FQ3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1CWOc9sOVKHP_W5OFVOAAYus_Uaw4jgsz
"""
...
arquivo = "/home/usuario/Documentos/Códigos/Estudo_do_contraste/MCMC/Resultados_FQ2_Fulldata.txt"  # Substitua pelo nome do seu arquivo
nomes_dos_parametros = [r"$H_0$", r"$\Omega_{m,0}$", r"$\sigma_{8,0}$", r"$M_B$", r"M"]  # Nomeie os parâmetros conforme necessário
...
plt.savefig("MCMC_FQ2_Fernanda.pdf", dpi=520, format='pdf', bbox_inches='tight')
plt.show()
