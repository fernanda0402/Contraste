...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 11:45:44 2024
...
plt.plot(z, solfs8_fQ3(70, 0.3, 0.8, 2.0331), color='maroon', label='$f_3(Q)$, M = 2.0331', linewidth = 2)
plt.plot(z, solfs8_fQ3(70, 0.3, 0.8, -2), color='peru', label='$f_3(Q)$, M = - 2', linewidth = 2)
#plt.xlim(-0.04, 2)
...
#plt.savefig('fs8(z)_fQ3.pdf', dpi=520, format='pdf', bbox_inches='tight')
plt.show()
