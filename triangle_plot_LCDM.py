...
arquivo = "/home/usuario/Documentos/Códigos/Estudo_do_contraste/MCMC/Resultados_LCDM_Fulldata.txt"  # Substitua pelo nome do seu arquivo
nomes_dos_parametros = [r"$H_0$", r"$\Omega_{m,0}$", r"$\sigma_{8,0}$", r"$M_B$"]  # Nomeie os parâmetros conforme necessário
...
plt.savefig("MCMC_LCDM_completo.pdf", dpi=520, format='pdf', bbox_inches='tight')
plt.show()
